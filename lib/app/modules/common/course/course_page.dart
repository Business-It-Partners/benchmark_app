        ...
        child: Obx(() {
          if (courseController.isLoading.value) {
            ...
            if (!courseController.loded.value) {
              ...
              log(" this is the title $title");
              log('Course Data: ${courseController.courseResponse.value.response!.data[0].subject}');
              final filteredCourses = courseController
                ...
                final stream = titleParts[1].toUpperCase();
                return course.grade == grades &&
                    (course.stream.toUpperCase() == stream ||
                        course.stream == "BOTH");
              }).toList();
